...
### すぐやる残タスク（優先順）
1. **使い方動画（約5分）を撮る**（台本＝`ONBOARDING-VIDEO-SCRIPT.md`／**読むだけ用の原稿＝`ONBOARDING-VIDEO-NARRATION.md`**）
   → YouTube**限定公開** → URLを `starter-kit/はじめにお読みください.md`／`COCONALA-LISTING-B.md`／納品案内文に反映。
